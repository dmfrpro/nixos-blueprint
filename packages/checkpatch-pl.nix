...
pkgs.stdenv.mkDerivation rec {
  ...
  checkpatchSrc = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/torvalds/linux/v${linux-rev}/scripts/checkpatch.pl";
    hash = "sha256-xxNnYrxG38btMawh8NWCWfVPERovtha3ZtPZFRc56+o=";
  };

  spellingTxt = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/torvalds/linux/v${linux-rev}/scripts/spelling.txt";
    hash = "sha256-PBUm0MxjZda2N7NeRwXiSt08Sh1Oc7wmHKt/buQHkmQ=";
  };

  constStructs = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/torvalds/linux/v${linux-rev}/scripts/const_structs.checkpatch";
    hash = "sha256-6gZPaRanR2NGgDdJSusnCq40t8l2F+hNQkyluHM1ObI=";
  };

  codespellDict = pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/codespell-project/codespell/${codespell-rev}/codespell_lib/data/dictionary.txt";
